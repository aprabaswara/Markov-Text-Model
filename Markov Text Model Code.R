...
setwd("C:/Users/001/Desktop/statistical programming")##Set working directory.
a <- scan("1581-0.txt",what="character",skip=156,encoding="UTF-8")##Read text data into a vector from the '1581-0.txt' file.
...
##make x represent the punctuation, vex represent the text.
